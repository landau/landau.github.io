...
var app = React.createClass({
  ...
  render: function() {
    ...
    return dom.div({className: 'container-fluid'}, dom.div({className: 'row'}, dom.div({className: 'col-md-12'}, dom.h2(null, 'JSONSelect Playground'), dom.div({className: 'form-group'}, dom.input({
      ...
      name: 'selector'
    })))), dom.div({className: 'row'}, dom.div({className: 'col-md-6'}, dom.textarea({
      className: 'form-control',
      name: 'json',
      onChange: this.onChange,
...
},{"JSONSelect":2,"react":138}],2:[function(require,module,exports){
